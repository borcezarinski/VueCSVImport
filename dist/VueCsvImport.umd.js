...
// CONCATENATED MODULE: ./src/components/VueCsvImport.vue?vue&type=template&id=482337ef&
  ...
  methods: {
    ...
    load: function load() {
      ...
      this.readFile(function (output) {
        ...
        for (var attr in _this.csv[0]) {
          _this.map = [];

          _this.map.push({
            attr: _this.csv[0][attr]
          });
