...
// CONCATENATED MODULE: ./src/components/VueCsvImport.vue?vue&type=template&id=936aee44&
  ...
  methods: {
    ...
    load: function load() {
      ...
      this.readFile(function (output) {
        ...
        console.log(_this.csv); // eslint-disable-next-line no-unused-vars
