...
// CONCATENATED MODULE: ./src/components/VueCsvImport.vue?vue&type=template&id=5b18ecf3&
...
/* harmony default export */ var VueCsvImportvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      dropzoneOptions: {
        url: _this2.url ? _this2.url : 'https://httpbin.org/post',
        thumbnailWidth: 150,
        maxFilesize: 1,
  ...
  methods: {
    ...
    load: function load() {
      ...
      this.readFile(function (output) {
        ...
        _this3.form.csv = _this3.buildMappedCsv();

        _this3.$emit('loadedData', _this3.form.csv); // this.$emit('loadedData', _this.csv);
